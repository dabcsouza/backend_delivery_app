...
const { validSale, invalidSaleBody } = require('../mocks/salesMocks');
...
describe('INTEGRATION TEST - Sales Route - ENDPOINT /sale', () => {
  ...
  describe('1) - Create a new Sale', () => {
    describe('1) - When When Sucess', () => {
      ...
      it('1) - Should return status code 201', async () => {
      ...
      it('3) - Should return a object with the correct keys', async () => {
    ...
    describe('2) - When When Fail', () => {
      describe('1) - When trying to create the product without the token', () => {
        ...
        it('1) - Should return status code 401', async () => {
      ...
      describe('2) - When trying to create the product with an invalid fiel', () => {
        ...
        it('1) - Should return status code 400', async () => {
  ...
  describe('2) - Get all Sales', () => {
    describe('1) - When When Sucess', () => {
      ...
      it('1) - Should return status code 200', async () => {
        expect(response.status).to.be.equal(200);
      });

      it('2) - Should return a array', async () => {
